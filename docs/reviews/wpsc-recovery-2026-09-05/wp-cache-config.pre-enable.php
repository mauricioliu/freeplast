...
$cache_path = '/home/freeplast/wpsc-cache/';
...
$cache_rejected_uri = array('wp-.*\\.php', 'index\\.php', '^(?!/(?:$|producto/[a-z0-9-]+/$|categoria-producto/[a-z0-9-]+/$))');
...
// Freeplast recovery 2026-09-05. Simple/PHP mode only; never enable Expert rewrite.
