# 0005 — La asistencia de dirección de despacho es un widget oficial detrás de una configuración ausente por defecto, con procedencia guardada como reclamo revisable
