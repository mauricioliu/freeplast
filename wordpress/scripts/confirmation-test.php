...
verify(str_contains($html, 'Confirmará disponibilidad, precios y condiciones'), 'the review scope is honest');
verify(!preg_match('/enviamos un correo|email enviado|te enviamos/i', $html), 'no delivery claim for merely persisting');
verify(str_contains($html, 'No estás realizando una compra.'), 'the no-purchase guard stays');
