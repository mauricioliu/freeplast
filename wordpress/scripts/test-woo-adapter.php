...
check(str_contains($stack_harness_source,'mails.length === 2 * (outcomes.new_request_count + 3)'),'The notification-event expectation is derived from the scenario ledger plus the three issue-#59 journeys, never hand-typed (native structural check)');
